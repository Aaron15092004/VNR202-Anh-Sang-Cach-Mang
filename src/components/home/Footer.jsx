      ...
      <div className="mb2-pb-fpsection position-relative pre-bg0 hidden0 light">
        ...
        >
          ...
          <div
            ...
            style={{
              marginTop: "0px",
              "--mb-pb-row_bgcolor": "rgb(27, 67, 50)",
                      ...
                      <div className="clearfix">
                        ...
                        >
                          <span className="headingtext fwglobal nline0">
                            Ánh Sáng Của Đảng - Lịch sử Đảng Cộng sản Việt Nam
                          </span>
                        </h4>
                        ...
                        <ul
                          ...
                          style={{
                            ...
                            "--mb2-pb-listhcolor": "rgb(244, 163, 0)",
                        ...
                        >
                          {[
                            "Dẫn lối bằng lý tưởng cách mạng",
                            "Từng chuyên đề theo dòng lịch sử",
                            "Ôn luyện chủ động, khắc ghi sâu sắc",
                  ...
                  <div className="mb2-pb-column col-lg-5 noempty light align-none aligncnone mobcenter1 moborder0">
                    ...
                    >
                      <div className="clearfix">
                        ...
                        >
                          <span className="headingtext fwglobal nline0">
                            Không gian học tập dưới ánh sáng của Đảng
                          </span>
                        </h4>
                            ...
                            <li className="mb2-pb-listicon_item">
                              <div className="item-content">
                                <span
                                  ...
                                  style={{ color: "rgb(244, 163, 0)" }}
                                >
                                  <i className="bi bi-envelope-at"></i>
                                </span>
                                <span className="list-text">
                                  anhsangcuadang.local
                                </span>
                              </div>
                            </li>
                            <li className="mb2-pb-listicon_item">
                        ...
                        <div
                          ...
                          style={{
                            ...
                            "--mb2-social-color": "rgb(45, 106, 79)",
                            "--mb2-social-borcolor": "rgb(45, 106, 79)",
                            "--mb2-social-hcolor": "rgb(255, 255, 255)",
                            "--mb2-social-hbgcolor": "rgb(45, 106, 79)",
                            "--mb2-social-hborcolor": "rgb(45, 106, 79)",
                          }}
                        >
                      ...
                      <div className="clearfix">
                        ...
                        >
                          ...
                          <span className="after">
                            Ánh Sáng Của Đảng. All rights reserved.
                          </span>
                        </div>
                      </div>
                    </div>
